...
import {analyzeAtsScore,applyJob,getApplications,getAppliedJobs,updateStatus} from "../controllers/application.controller.js"

const router = express.Router();

router.route("/apply/:id").get(verifyJWT, applyJob);
router.route("/get").get(verifyJWT, getAppliedJobs);
router.route("/ats-score").post(analyzeAtsScore);
